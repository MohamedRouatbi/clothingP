        ...
        <section className={styles.heroText}>
          ...
          <div className={styles.descriptionContainerParent}>
            ...
            <div className={styles.laundryHeroes}>
              اهتم <b>بملابسك</b> بدون ما تضيع وقتك. نستلم الملابس من باب البيت، نغسلها بعناية حسب نوع القماش، مع تعقيم وكي احترافي يخليها جاهزة للارتداء فورًا.
            </div>
          </div>
